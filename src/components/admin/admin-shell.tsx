...
export function AdminShell({ user }: { user: { email: string; name: string; role: string } }) {
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden min-h-0">
      {/* Mobile tabs */}
      <div className="md:hidden shrink-0 border-b border-border bg-card overflow-x-auto">
      ...
      <div className="flex-1 flex min-h-0 overflow-hidden">
        {/* Sidebar */}
        <aside className="w-64 bg-card border-l border-border flex-col shrink-0 hidden md:flex">
        ...
        {/* Content */}
        <div className="flex-1 overflow-y-auto bg-background custom-scroll min-h-0">
